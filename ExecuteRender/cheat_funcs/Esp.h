...
{
	float xs = Vars::Global::ScreenWidth / 2, ys = Vars::Global::ScreenHigh / 2;
	GUI::Render.Ñircle(Vector2{ xs, ys }, FLOAT4TOD3DCOLOR(Vars::Color::Fov), Vars::AimBot::Fov, 0.7f);
...
void DrawSilentFOV()
{
	...
	float xs = Vars::Global::ScreenWidth / 2, ys = Vars::Global::ScreenHigh / 2;
	GUI::Render.Ñircle(Vector2{ xs, ys }, D2D1::ColorF(r, g, b, 1.f), Vars::AimBot::SilentFov, 0.5f);
	GUI::Render.Ñircle(Vector2{ xs, ys }, D2D1::ColorF(r, g, b, 1.f), Vars::AimBot::SilentFov, 0.5f);
}
